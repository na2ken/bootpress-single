<?php
/* Template Name: archive-wordpress.php */
get_header(); ?>
<!-- archive-wordpress template -->
    ...
    <div class="container">
        <div class="row">
            <div class="col-xs-12">
                ...
                <h1 class="text-center wow fadeInDown" data-wow-duration="2.5s" data-wow-delay="0s" >WordPressテーマ</h1>
...
$product_terms = wp_get_object_terms($post->ID, 'wordpress-cat');
...
if(!empty($product_terms)){
  if(!is_wp_error( $product_terms )){
    ...
    foreach($product_terms as $term){
      echo '<a href="'.get_term_link($term->slug, 'wordpress-cat').'">'.$term->name.'</a>, '; 
    }
    echo '';
  }
}
